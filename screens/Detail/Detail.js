...
export default function MovieDetailScreen({ route, navigation }) {
  ...
  const [movie, setMovie] = useState({
    ...
    banner: movieFromParams.banner || "", // Usar específicamente banner sin fallbacks
  ...
  // Verificar favoritos y progreso al cargar
  useEffect(() => {
  ...
  // Manejar la navegación y barra de tabs
  useFocusEffect(
    React.useCallback(() => {
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 80 }}>
        ...
        <View style={styles.contentContainer}>
          ...
          <View style={styles.actionButtonsContainer}>
            <TouchableOpacity style={styles.actionButton} onPress={handlePlayTrailer}>
          ...
          {/* Descripción */}
          <Text style={[styles.descriptionText, { color: colors.text }]}>{movie.description}</Text>
