...
const genreConfigs = [
  { title: "Películas Acción", category: "Action", icon: "flash-outline" },
  { title: "Películas Suspenso", category: "Suspense", icon: "search-outline" },
  { title: "Películas Terror", category: "Horror", icon: "skull-outline" },
  { title: "Películas Drama", category: "Drama", icon: "bulb-outline" },
  { title: "Películas Animadas", category: "Animated", icon: "color-palette-outline" },
  { title: "Películas Comedia", category: "Comedy", icon: "happy-outline" },
  { title: "Películas Ciencia Ficcion", category: "Science fiction", icon: "planet-outline" },
  { title: "Películas Aventura", category: "Aventured", icon: "map-outline" },
  { title: "Películas Romance", category: "Romance", icon: "heart" },
  { title: "Películas Cristianas", category: "Christian", icon: "book-outline" },
];
