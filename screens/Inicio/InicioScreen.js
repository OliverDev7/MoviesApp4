...
const WelcomeScreen = ({ navigation }) => {
  ...
  const backgroundImages = [
    "", // Imagen de película popular
    "", // Otra imagen de película
    "", // Otra imagen de película
  ]
      ...
      >
        ...
        <View style={styles.contentWrapper}>
          ...
          >
            ...
            <Text style={styles.logoText}>MovieFilm</Text>
          </Animated.View>
          ...
          >
            <Text style={styles.title}>Free Movies</Text>
            <Text style={styles.subtitle}>
            Enjoy your favorite movies and watch them wherever you want on whatever device you want
            </Text>
...
const styles = StyleSheet.create({
  ...
  linkText: {
    color: '#E91E63', // o algún otro color llamativo
